...
@Autonomous(name = "Autonomous Left India", group = "BTJ #13452")
// @Disabled
public class AutonomousLeft extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        sleeveSensor = hardwareMap.get(ColorSensor.class, "colorSensorRight");
        ...
        for(int i = 0; i < 4; i++){
            ...
            driveByEncoder(-0.8,0,55,0);
            sleep(200);
            driveByEncoder(0.8,-90,25,0);
            driveUntilJunction(0.25,-90,0);
            driveByEncoder(0.25,-90,4,0);
            sleep(100);
            driveByEncoder(-1,0,8,0);
            driveToJunction(-0.2,0,0);
            driveByEncoder(-0.2,0,2,0);
